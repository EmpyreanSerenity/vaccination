				 ...
				 <div class="boxed-icon">
						 ...
						 <tr><td><b>Sex:</b></td><td><div class="a"><?php echo $info[$i]["gender"]?></td></tr>
				             <tr><td><br></td></tr>
						      ...
						      <a href="editchild.php?id=<?= $info[$i]["ch_id"];?>" class="button" style="background-color: lightskyblue ;color: black" >Edit</a>
					         <a href="deletechild.php?id=<?= $info[$i]["ch_id"];?>" class="button" style="background-color: lightskyblue ;color: black" >Drop</a>
							</div>
						</div>
				<?php 
			 }
