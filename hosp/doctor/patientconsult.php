...
<?php
    ...
    'edit'=>array('label'=>'History','link'=>'history.php','params'=>array('id'=>'email'),'attributes'=>array('class'=>'btn btn-success')),
...
$condition="cdate='".$cdate."' and status=2 and d_id=".$name."";
